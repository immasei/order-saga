...
//
//    // Constructor
//    public DeliveryRecord(Order order, Warehouse warehouse, String trackingNumber, String status, java.time.LocalDateTime shippedAt, java.time.LocalDateTime deliveredAt) {
//        this.order = order;
